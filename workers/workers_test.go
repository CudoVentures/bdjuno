...
func (mw mockWorker) Start(ctx context.Context, parseCfg *parsecmdtypes.Config, parseCtx *parser.Context,
...
func TestStartWorkers(t *testing.T) {
	...
	var parseCfg parsecmdtypes.Config
...
func TestBaseWorkerStart(t *testing.T) {
	...
	job := func(parseCfg *parsecmdtypes.Config, parseCtx *parser.Context, storage keyValueStorage) error {
		executionsCount += 1
		return nil
	}
	bw := baseWorker{}
