...
import (
	...
	junoutils "github.com/forbole/juno/v5/types/utils"
	"github.com/spf13/cobra"
)

// NewParseGenesisCmd returns the Cobra command allowing to parse the genesis file
func NewParseGenesisCmd(parseCfg *parsecmdtypes.Config) *cobra.Command {
	return &cobra.Command{
		...
		PreRunE: parsecmdtypes.ReadConfigPreRunE(parseCfg),
