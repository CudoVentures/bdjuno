...
CMD ["/bin/bash", "-c", "bdjuno database migrate --home /usr/local/bdjuno/bdjuno/ && bdjuno parse-genesis --home /usr/local/bdjuno/bdjuno/ && bdjuno start --home /usr/local/bdjuno/bdjuno/"]
